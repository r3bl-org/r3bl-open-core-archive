...
//! Implementation of nom input traits for `AsStrSlice`.
//!
...
//! change the nom trait signatures, we use type aliases to clarify this:
//!
...
// Custom extension methods that aren't part of nom traits
impl<'a> AsStrSlice<'a> {
}