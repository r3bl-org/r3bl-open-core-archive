...
use crate::{list,
            local_constants::{CHECKED, LIST_PREFIX_BASE_WIDTH, NEW_LINE,
            ...
            AsStrSlice, CheckboxParsePolicy, InlineString,
            InlineVec, List, MdLineFragment, MdLineFragments, NErr, NError,
            NErrorKind};
use crate::local_types::{Lines, SmartListIRAlt, SmartListLineAlt};
use crate::BulletKind;
use crate::CharLengthExt;
...
fn parse_unordered_list(
    ...
    Ok((
        ...
        SmartListIRAlt {
            ...
            content_lines: List::from(content_lines.into_vec()),
        },
    ))
}
...
fn parse_ordered_list(
    ...
    fn parse_ordered_list_bullet(input_str: &str) -> IResult<&str, BulletKind> {
        ...
        Ok((bullet_str, BulletKind::Ordered(number as usize)))
    }
    ...
    if input.lines.len() == 1 {
        ...
        return Ok((
            ...
            smallvec![SmartListLineAlt {
                indent,
                bullet_str: bullet.extract_to_line_end().into(),
...
mod verify_rest {
    use super::{AsStrSlice, ORDERED_LIST_PARTIAL_PREFIX, SPACE_CHAR,
