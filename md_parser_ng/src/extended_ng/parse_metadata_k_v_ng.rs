...
mod test_parse_title_no_eol {
    use r3bl_tui::fg_black;

    use super::*;
    use crate::{as_str_slice_test_case, assert_eq2, inline_string,
                local_constants::TITLE, local_types::InlineStringCow, NErr, NErrorKind};
    ...
    fn test_not_quoted_no_eol() {
        ...
        // Debug output removed - fg_black not available
