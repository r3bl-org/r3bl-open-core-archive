...
use crate::{local_constants::{COMMA_CHAR, COMMA, COLON, SPACE, NEW_LINE_CHAR, SPACE_CHAR},
            inline_vec, list,
...
pub fn parse_line_csv_no_advance_ng<'a>(
    ...
    // Normal case.
        ...
        Ok((rem_new, List::from(vec_tags_text.into_vec())))
    }
}
...
mod test_parse_tags_opt_eol {
    use super::*;
    use crate::{as_str_slice_test_case, assert_eq2, local_constants::TAGS, GCString};
