...
use crate::{local_constants::{AUTHORS, DATE, TAGS, TITLE},
            list,
...
/// - Implements nom input traits for seamless nom parser integration
        ...
        alt((
            ...
            |input: AsStrSlice<'a>| {
                input.ensure_advance_with_parser(&mut map(
                    ...
                    |(list, bullet_kind, indent)| {
                        MdElement::SmartList((list, bullet_kind, indent))
                    },
                ))
            },
            // Code block parser
