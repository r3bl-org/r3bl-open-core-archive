...
use nom::{bytes::complete::{tag, take_while1},
          combinator::map,
          sequence::terminated,
          IResult, Parser, Input};

use crate::{local_constants, AsStrSlice, CharLengthExt, GCString, HeadingData,
            HeadingLevel};
...
pub fn parse_line_heading_no_advance_ng(input: AsStrSlice<'_>) -> IResult<AsStrSlice<'_>, HeadingData<'_>> {
    ...
    Ok((consumed_input, HeadingData { heading_level: level, text: remaining_text }))
}
...
fn parse_heading_tag_ng<'a>(input: AsStrSlice<'a>) -> IResult<AsStrSlice<'a>, HeadingLevel> {
    map(
        terminated(
            /* output `#`+ */ take_while1(|it| it == local_constants::HEADING_CHAR),
            /* ends with (discarded) */ tag(local_constants::SPACE),
        ),
...
mod tests {
    ...
    fn test_parse_header_h1() {
        ...
        assert_eq2!(remainder.to_string(), "");
        assert_eq2!(heading_data.heading_level, 1.into());
    ...
    fn test_parse_header_h2() {
        ...
        let (remainder, heading_data) = parse_line_heading_no_advance_ng(input).unwrap();
        assert_eq2!(remainder.to_string(), "");
        assert_eq2!(heading_data.heading_level, 2.into());
    ...
    fn test_parse_header_h3_with_extra_space() {
        ...
        let (remainder, heading_data) = parse_line_heading_no_advance_ng(input).unwrap();
        assert_eq2!(remainder.to_string(), "");
        assert_eq2!(heading_data.heading_level, 3.into());
    ...
    fn test_parse_header_h4() {
        ...
        let (remainder, heading_data) = parse_line_heading_no_advance_ng(input).unwrap();
        assert_eq2!(remainder.to_string(), "");
        assert_eq2!(heading_data.heading_level, 4.into());
    ...
    fn test_parse_header_h5() {
        ...
        let (remainder, heading_data) = parse_line_heading_no_advance_ng(input).unwrap();
        assert_eq2!(remainder.to_string(), "");
        assert_eq2!(heading_data.heading_level, 5.into());
    ...
    fn test_parse_header_h6() {
        ...
        let (remainder, heading_data) = parse_line_heading_no_advance_ng(input).unwrap();
        assert_eq2!(remainder.to_string(), "");
        assert_eq2!(heading_data.heading_level, 6.into());
    ...
    fn test_parse_header_h7() {
        ...
        let (remainder, heading_data) = parse_line_heading_no_advance_ng(input).unwrap();
        assert_eq2!(remainder.to_string(), "");
        assert_eq2!(heading_data.heading_level, 7.into());
